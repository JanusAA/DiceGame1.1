...
public class Game {
	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("Du har indtastet >>" + p1.getName() + "<< indtast >>Y<< for at bekræfte, eller N for at rette navnet.");
		...
		do {
			...
			System.out.println("\n" + "Spiller " + p1.getName() + " slå med raffelbærgeret ved at trykke på enter");
			...
			System.out.println("\n" + "Spiller " + p2.getName() + " slå med raffelbærgeret ved at trykke på enter");
